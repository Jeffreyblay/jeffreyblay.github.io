...
">
  ...
  ">
    ...
    <p style="font-size: 1.2rem;">
      ...
      Currently, I am pursuing a **Ph.D. in Applied Science**, specializing in Geospatial Data Science,  
      with years of experience in remote sensing, GIS, spatial analysis, geospatial AI, urban analytics, and data pipelines.
...
-->
<style>
  /* Override the default page content styling */
  .page__content {
    margin: 0 !important;
    padding: 0 !important;
    width: 100% !important;
